  ...
  Widget build(BuildContext context) => _SectionCard(
    ...
    children: <Widget>[
      _Metrics(values: <String, String>{
        LocaleKeys.userCustodyTotal.tr(): custody.summary.totalMachines.toString(),
        LocaleKeys.userCustodyInHand.tr(): custody.summary.inHand.toString(),
        LocaleKeys.userCustodyAtMerchants.tr(): custody.summary.withMerchants.toString(),
      }),
  ...
  Widget build(BuildContext context) => _SectionCard(
    ...
    children: <Widget>[
      _Metrics(values: <String, String>{
        ...
        LocaleKeys.userViolationsCharged.tr(): Formatters.currency(summary.totalCharged),
      }),
      ListTile(
        contentPadding: EdgeInsets.zero,
...
class UserActivitySection extends StatelessWidget {
  ...
  Widget build(BuildContext context) => _SectionCard(
    ...
    children: activity.isEmpty
        ...
        : activity.map((transfer) => ListTile(
            contentPadding: EdgeInsets.zero,
            title: Text(transfer.referenceNo, textDirection: TextDirection.ltr),
            subtitle: Text('${TransferLabels.type(transfer.type)} • ${Formatters.date(transfer.occurredAt)}'),
...
class _Metrics extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Wrap(
    ...
    children: values.entries.map((entry) => Container(
